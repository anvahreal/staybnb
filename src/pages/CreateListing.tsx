    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 py-8 px-4">
        <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-8 animate-in slide-in-from-right-4 duration-500">
              <div>
                ...
                <p className="text-slate-500 font-medium">
                  Tell us where your place is and how much you charge.
                </p>
              </div>
              ...
              <Card className="border-none shadow-soft rounded-[2.5rem] p-8 space-y-6">
                <FormInput
                  label="Listing Title"
                  placeholder="e.g. Modern Waterfront Penthouse"
                />
                ...
                <FormInput
                  ...
                  placeholder="e.g. 12B Adetokunbo Ademola St"
          ...
          {/* STEP 2: DETAILS - MOBILE OPTIMIZED */}
          {step === 2 && (
            <div className="space-y-8 animate-in slide-in-from-right-4 duration-500 pb-20">
              <div>
                ...
                <p className="text-slate-500 font-medium text-sm">
                  Help guests understand what they're booking.
                </p>
              </div>

              <Card className="border-none shadow-soft rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 space-y-8 bg-white">
                {/* Stacked counters on mobile, side-by-side on desktop */}
                ...
                <div className="space-y-4">
                  ...
                  {/* Adjusted grid for mobile buttons */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {[
                      ...
                      <button
                        key={amenity}
                        type="button"
                        className="flex items-center justify-between p-4 rounded-2xl border-2 border-slate-50 hover:border-slate-900 active:bg-slate-900 active:text-white transition-all font-bold text-sm text-slate-700 bg-slate-50/50"
                      >
                        <span>{amenity}</span>
                        <CheckCircle2 className="h-4 w-4 text-slate-300 group-active:text-white" />
                      </button>
                    ))}
                  </div>
                </div>
          ...
          {step === 3 && (
            <div className="space-y-8 animate-in slide-in-from-right-4 duration-500">
              <div>
                ...
                <p className="text-slate-500 font-medium">
                  Show off your space! Upload at least 5 high-quality photos.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="aspect-square rounded-2xl bg-slate-200 border-2 border-white shadow-sm"
                    />
                  ))}
                </div>
              </div>
      ...
      <footer className="bg-white border-t p-6 pb-10">
        <div className="max-w-2xl mx-auto flex justify-between gap-4">
          ...
          <Button
            onClick={
              step === totalSteps ? () => navigate("/host/dashboard") : nextStep
            }
    ...
    <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="h-8 w-8 rounded-full bg-white shadow-sm flex items-center justify-center font-black"
        >
          -
        </button>
        ...
        <button
          ...
          className="h-8 w-8 rounded-full bg-slate-900 text-white shadow-sm flex items-center justify-center font-black"
        >
          +
        </button>
      </div>
